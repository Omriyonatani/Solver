...
const RealVariable& solver::operator+(const RealVariable& c1, const complex<double>& c2){
    return c1;
}
const RealVariable& solver::operator+(const complex<double>& c1, const RealVariable& c2){
    return c2;
}
